...
func (h *WatchlistHandler) CreateWatchlist(c *gin.Context) {
	...
	log.Printf("INFO: Creating watchlist '%s' for user %s", req.WatchlistName, userID)
	...
	log.Printf("INFO: Successfully created watchlist %s for user %s", watchlist.ID, userID)
